# pages/A4_🗂️_Beheer_Gereedschappen.py
...
st.set_page_config(page_title="Beheer – Gereedschappen", layout="wide")
init_db(); render_nav()
...
try:
    ...
    render_catalog_admin(Model=Tool, title="🗂️ Beheer – Gereedschappen", page_size=20)
