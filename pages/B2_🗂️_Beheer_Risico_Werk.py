# pages/B2_🗂️_Beheer_Risico_Werk.py
...
from models import WorkRiskCat

init_db()
cfg = load_cfg()
require_role(cfg, {"beheerder"})
st.set_page_config(page_title="Beheer – Risico's Werk", layout="wide")
render_nav()
