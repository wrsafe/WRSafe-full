# pages/B3_🗂️_Beheer_Risico_Omgeving.py
...
from models import EnvRiskCat

init_db()
cfg = load_cfg()
require_role(cfg, {"beheerder"})
st.set_page_config(page_title="Beheer – Risico's Omgeving", layout="wide")
render_nav()
...
render_catalog_admin(
    Model=EnvRiskCat,
    title="🛠️ Beheer – Risico's Omgeving",
