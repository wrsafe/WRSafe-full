# pages/A3_🗂️_Beheer_Werkwijzen.py
...
st.set_page_config(page_title="Beheer – Werkwijzen", layout="wide")
init_db(); render_nav()
...
try:
    ...
    render_catalog_admin(Model=WorkType, title="🗂️ Beheer – Werkwijzen", page_size=20)
